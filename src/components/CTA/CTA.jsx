      ...
      <div className="container cta__inner">
        <h2 className="cta__headline">
          <div className="cta__line">
            <span className="cta__word">LET&apos;S</span>
            <a href="mailto:hello@irisdigitallab.com" className="cta__connect" aria-label="Connect">
              <span>Connect</span>
            ...
            <span className="cta__word">WORK</span>
          </div>
          ...
          <div className="cta__line cta__line--together">
            ...
            <span className="cta__word cta__word--soft">
              <img src="/assets/iris-isotype.svg" alt="" className="cta__inline-iso" /> GETHER
            </span>
          </div>

          <div className="cta__line">
            <span className="cta__word">LET&apos;S CREATE.</span>
          </div>
        </h2>
